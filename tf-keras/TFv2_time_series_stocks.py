...
# Its a tutorial and not a REAL forecasting for investment decision.....!
# updte for TFv2 beta1
...
#1491226200	2363.6101	42.33	143.68	129.63
#1491226260	2364.1001	42.36	143.7	130.32
#1491226320	2362.6799	42.31	143.6901	130.225
...
# disable eager excution for TFv2
...
out = tf.transpose(a=tf.add(tf.matmul(hidden_4, W_out), bias_out))
# Cost function
mse = tf.reduce_mean(input_tensor=tf.math.squared_difference(out, Y))
# Optimizer
